    ...
    export default {
        ...
        methods: {
            ...
            handleShowHide: function() {
                ...
                $(".percentunit").removeAttr("disabled", "disabled");
            ...
            sortDataByGender: function(dataloop) {
                ...
                for (let i = 0, len = dataloop.length; i < len; i++) {
                    ...
                    if (i == len - 1) {
                        ...
                        var tempArr = [];
                        var tempOuter = [];
                        tempArr.push({ y: male,  dataLabels: {
                                enabled: true,
                                color: 'black',
                                style : {
                                    fontSize : 10,
                            ...
                            },name: "Male", color: "green" });
                        tempArr.push({ y: female, dataLabels: {
                                enabled: true,
                                style : {
                                    fontSize : 10,
                                    textShadow: false
            ...
            sortDataByAge: function(dataloop) {
                ...
                for (let i = 0, len = dataloop.length; i < len; i++) {
                    ...
                    if (i == len - 1) {
                        ...
                        var tempArr = [];
                        var tempOuter = [];
                        tempArr.push({ name: "0-4 years", dataLabels: {
                                enabled: true,
                                color: 'black',
                                style : {
                                    fontSize : 10,
                            ...
                            },y: age_04, color: "green" });
                        tempArr.push({ name: "5-14 years", dataLabels: {
                                enabled: true,
                                style : {
                                    fontSize : 10,
                                    textShadow: false
                                ...
                                color: 'black'
                            },y: age_514, color: "blue" });
                        tempArr.push({ name: "15-29 years",dataLabels: {
                                enabled: true,
                                style : {
                                    fontSize : 10,
                                    textShadow: false
                                ...
                                color: 'black'
                            }, y: age_1529, color: "yellow" });
                        tempArr.push({ name: "30-49 years",dataLabels: {
                                enabled: true,
                                style : {
                                    fontSize : 10,
                                    textShadow: false
                                ...
                                color: 'black'
                            }, y: age_3049, color: "pink" });
                        tempArr.push({ name: "50-59 years",dataLabels: {
                                enabled: true,
                                style : {
                                    fontSize : 10,
                                    textShadow: false
                                ...
                                color: 'black'
                            }, y: age_5059, color: "gray" });
                        tempArr.push({ name: "60-69 years", dataLabels: {
                                enabled: true,
                                style : {
                                    fontSize : 10,
                                    textShadow: false
                        ...
                        tempArr.push({ name: "70-79 years", dataLabels: {
                                ...
                                color: 'black'
                            },y: age_7079, color: "skyblue" });
                        tempArr.push({
                            name: "80 years and above",dataLabels: {
                                enabled: true,
                                style : {
                                    fontSize : 10,
                                    textShadow: false
            ...
            sortDataBySite: function(dataloop) {
                ...
                for (let i = 0, len = dataloop.length; i < len; i++) {
                    ...
                    if (i == len - 1) {
                        ...
                        var tempArr = [];
                        var tempOuter = [];
                        tempArr.push({ name: "Urban",dataLabels: {
                                enabled: true,
                                style : {
                                    fontSize : 10,
                                    textShadow: false
                        ...
                        tempArr.push({ name: "Rural", dataLabels: {
                                enabled: true,
                                style : {
                                    fontSize : 10,
                                    textShadow: false
