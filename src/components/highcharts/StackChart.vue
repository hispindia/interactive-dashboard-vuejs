    ...
    export default {
        ...
        methods: {
            ...
            setColorsPop: function() {
                ...
                this.ages[0]["ppIxci61gTu"].color ="rgb(142, 68, 173)";
                this.ages[0]["yvdQkzHuq2E"].color = "rgb(211, 84, 0)";
                this.ages[0]["fohLv27MtjN"].color = "rgb(40, 55, 71)";
                this.ages[0]["FPQcIz7kBvD"].color = "rgb(24, 106, 59 )";
                this.ages[0]["fuZTseIa9nS"].color = "rgb(133, 193, 233)";
                this.ages[0]["rHmIMu8bVmy"].color = "rgb(217, 136, 128)";
            },
                    ...
                    if (this.chartType != "rate") {
                        ...
                        temp[0][disease_id].data[2] === undefined
                            ? (temp[0][disease_id].data[2] =
                                ((value / this.populationdata.both) ))
                            : (temp[0][disease_id].data[2] +=
                                ((value / this.populationdata.both) ));
                    }
                    ...
                    for (let i = 0, len = dataloop.length; i < len; i++) {
                        ...
                        if (this.chartType != "rate") {
                            ...
                            age_id_match == variables.age_0_4_id
                                ? temp[0][disease_id].data[0] === undefined
                                ? (temp[0][disease_id].data[0] =
                                    ((value / this.populationdata.age0_4).toFixed(8).replace(/\.?0+$/,"")*10000))
                                : (temp[0][disease_id].data[0] +=
                                    ((value / this.populationdata.age0_4).toFixed(8).replace(/\.?0+$/,"")*10000))
                                : age_id_match == variables.age_5_14_id
                                ? temp[0][disease_id].data[1] === undefined
                                    ? (temp[0][disease_id].data[1] =
                                        ((value / this.populationdata.age5_14).toFixed(8).replace(/\.?0+$/,"")*10000))
                                    : (temp[0][disease_id].data[1] +=
                                        ((value / this.populationdata.age5_14).toFixed(8).replace(/\.?0+$/,"")*10000))
                                : age_id_match == variables.age_15_29_id
                                    ? temp[0][disease_id].data[2] === undefined
                                        ? (temp[0][disease_id].data[2] =
                                            ((value / this.populationdata.age15_29).toFixed(8).replace(/\.?0+$/,"")*10000))
                                        : (temp[0][disease_id].data[2] +=
                                            ((value / this.populationdata.age15_29).toFixed(8).replace(/\.?0+$/,"")*10000))
                                    : age_id_match == variables.age_30_49_id
                                        ? temp[0][disease_id].data[3] === undefined
                                            ? (temp[0][disease_id].data[3] =
                                                ((value / this.populationdata.age30_49).toFixed(8).replace(/\.?0+$/,"")*10000))
                                            : (temp[0][disease_id].data[3] +=
                                                ((value / this.populationdata.age30_49).toFixed(8).replace(/\.?0+$/,"")*10000))
                                        : age_id_match == variables.age_50_59_id
                                            ? temp[0][disease_id].data[4] === undefined
                                                ? (temp[0][disease_id].data[4] =
                                                    ((value / this.populationdata.age50_59).toFixed(8).replace(/\.?0+$/,"")*10000))
                                                : (temp[0][disease_id].data[4] +=
                                                    ((value / this.populationdata.age50_59).toFixed(8).replace(/\.?0+$/,"")*10000))
                                            : age_id_match == variables.age_60_69_id
                                                ? temp[0][disease_id].data[5] === undefined
                                                    ? (temp[0][disease_id].data[5] =
                                                        ((value / this.populationdata.age60_69).toFixed(8).replace(/\.?0+$/,"")*10000))
                                                    : (temp[0][disease_id].data[5] +=
                                                        ((value / this.populationdata.age60_69).toFixed(8).replace(/\.?0+$/,"")*10000))
                                                : age_id_match == variables.age_70_79_id
                                                    ? temp[0][disease_id].data[6] === undefined
                                                        ? (temp[0][disease_id].data[6] =
                                                            ((value / this.populationdata.age70_79).toFixed(8).replace(/\.?0+$/,"")*10000))
                                                        : (temp[0][disease_id].data[6] +=
                                                            ((value / this.populationdata.age70_79).toFixed(8).replace(/\.?0+$/,"")*10000))
                                                    : temp[0][disease_id].data[7] === undefined
